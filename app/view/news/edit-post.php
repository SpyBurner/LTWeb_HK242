...
<body>
    <?php 
        ...
        $sql = "SELECT * FROM blogpost WHERE blogid = ?";
                ...
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo mw-50 h-auto">
                            <a href="index.html"><img src="../../img/header-logo2-nobg.png" alt="header logo" srcset=""></a>
                        </div>
                        ...
                        <li class="sidebar-item active">
                            ...
                            <ul class="submenu active submenu-open">
                                ...
                                <li class="submenu-item active">
                                    <a class="submenu-link">Sửa bài viết</a>
                                </li>
                            </ul>
                        </li>
                                ...
                                <div class="tab-pane fade active show" id="add-article">
                                    ...
                                    <form id="articleForm" class="mt-4">  
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" value="<?= $row["title"]?>" class="form-control" id="articleTitle" required>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="articleContent" rows="12" required><?= htmlspecialchars($row["content"]); ?></textarea>
                                        </div>
