            ...
            <div id="search-nav" class="flex flex-col gap-6 justify-between w-full">
                ...
                <div class="flex flex-row items-center">
                    ...
                    <nav class="flex-5 flex flex-row justify-center">
                        <a href="../home/home.html" class="btn btn-ghost hover:bg-base-100 rounded-none py-2 px-6">HOME</a>
    ...
    <div id="body" class="m-6 md:w-3/4 md:mx-auto">
        ...
        <div class="card bg-base-100 max-w-2xl w-full shadow-2xl mx-auto p-4">
            <div class="rounded-full bg-base-200 p-2 flex gap-2 w-1/2 mx-auto">
                <a href="login.php" class="btn flex-1 bg-base-100 border border-primary">LOGIN</a>
                <a href="register.php" class="btn flex-1">REGISTER</a>
            </div>
